...
Then the script assumes death occurs on average 22.2 days after infection,
...
The end result is a simple tool that can not only predict deaths up to ~22.2
...
Ages 50-59:
Number of deaths: 547
Gamma distribution params:
mean = 25.1
shape = 2.06

Ages 60-69:
Number of deaths: 1205
Gamma distribution params:
mean = 23.6
shape = 2.29

Ages 70-79:
Number of deaths: 1938
Gamma distribution params:
mean = 22.7
shape = 2.23

Ages 80-89:
Number of deaths: 2190
Gamma distribution params:
mean = 21.7
shape = 2.05

Ages 90+:
Number of deaths: 1174
Gamma distribution params:
mean = 19.4
shape = 1.99

All ages:
Number of deaths: 7422
Gamma distribution params:
mean = 22.2
shape = 2.09
```

The overall (all ages) mean of 22.2 days is comparable to other published estimates, however our
distribution is wider (ie. smaller shape parameter of 2.09) because many deaths
...
they are based on a much larger sample of 7422 deaths. The long tail
...
```
$ ./heatmap.py
Opening data_fdoh/2020-08-02-07-44-56.csv
...
period_start, 00-04, 05-09, 10-14, 15-19, 20-24, 25-29, 30-34, 35-39, 40-44, 45-49, 50-54, 55-59, 60-64, 65-69, 70-74, 75-79, 80-84, 85+, median_age
  ...
  2020-03-22,    10,     5,    17,    49,   204,   222,   284,   254,   272,   273,   315,   298,   235,   235,   237,   176,   120,    84,  50.0
  ...
  2020-05-10,    51,    58,    60,   151,   313,   401,   435,   399,   354,   399,   424,   432,   352,   270,   261,   191,   225,   335,  49.0
  2020-05-17,    94,    88,    98,   193,   329,   392,   423,   417,   392,   443,   357,   379,   306,   257,   197,   189,   161,   312,  46.0
  2020-05-24,    91,    94,   136,   242,   425,   481,   545,   490,   468,   447,   375,   445,   336,   237,   165,   159,   145,   207,  42.0
  2020-05-31,   162,   161,   201,   401,   624,   707,   693,   707,   594,   618,   560,   540,   413,   333,   231,   182,   138,   270,  40.0
  2020-06-07,   257,   256,   290,   592,  1405,  1291,  1158,  1022,   814,   845,   808,   691,   577,   406,   322,   236,   206,   328,  37.0
  2020-06-14,   392,   342,   435,  1275,  3359,  2755,  2319,  1939,  1607,  1556,  1365,  1280,   916,   651,   529,   378,   272,   377,  34.0
  2020-06-21,   767,   645,   763,  2761,  6599,  5832,  4813,  3910,  3231,  3198,  2948,  2441,  1870,  1350,   991,   718,   501,   725,  34.0
  2020-06-28,  1071,  1047,  1202,  3476,  7131,  6998,  6233,  5303,  4597,  4456,  4310,  3751,  2822,  2036,  1463,  1056,   679,   830,  36.0
  2020-07-05,  1112,  1188,  1527,  4128,  7238,  7330,  6972,  5970,  5580,  5776,  5558,  5013,  3770,  2708,  1999,  1497,  1063,  1308,  39.0
  2020-07-12,  1384,  1381,  1929,  4481,  7222,  7579,  7449,  6836,  6645,  6617,  6551,  5938,  4610,  3452,  2598,  1924,  1428,  1758,  41.0
  2020-07-19,  1426,  1407,  2028,  4148,  6322,  6432,  6716,  6391,  5994,  6278,  6073,  5541,  4438,  3273,  2459,  1893,  1369,  1792,  41.0
  2020-07-26,  1131,  1254,  1699,  3543,  5245,  5288,  5656,  5480,  5008,  5417,  5315,  5123,  3878,  2927,  2153,  1567,  1253,  1578,  42.0
(Last period's data may be incomplete. Age unknown for 864 out of 487132 cases.)
```
