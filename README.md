...
Then the script assumes death occurs on average 19.2 days after infection,
...
Ages 70-79:
Number of deaths: 1039
Gamma distribution params:
mean = 19.8
shape = 2.00

Ages 80-89:
Number of deaths: 1184
Gamma distribution params:
mean = 18.2
shape = 2.00

Ages 90+:
Number of deaths: 653
Gamma distribution params:
mean = 16.8
shape = 2.00

All ages:
Number of deaths: 4022
Gamma distribution params:
mean = 19.2
shape = 1.95
```

The overall (all ages) mean of 19.2 days is comparable to other published estimates, however our
distribution is wider (ie. smaller shape parameter of 1.95) because many deaths
...
they are based on a much larger sample of 4022 deaths. The long tail
